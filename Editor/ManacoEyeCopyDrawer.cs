...
namespace com.kakunvr.manaco.Editor
{
    public static class ManacoEyeCopyDrawer
    {
            ...
            System.Action<int, bool> openSelector)
        {
            ...
            EditorGUI.indentLevel++;
            EditorGUILayout.LabelField(ManacoLocale.T("Message.SourceUVIslandCount", sourceEyePolygonRegionsProp.arraySize), EditorStyles.miniLabel);
            EditorGUI.indentLevel--;
        ...
        {
            EditorGUI.DrawRect(GUILayoutUtility.GetRect(0, 1, GUILayout.ExpandWidth(true)), SectionLineColor);
