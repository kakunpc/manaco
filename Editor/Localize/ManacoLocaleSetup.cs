    ...
    public static class ManacoLocaleSetup
    {
        ...
        private static void BuildJaLocale(ManacoLocaleData d)
        {
            ...
            d.entries = new List<ManacoLocaleData.LocaleEntry>
            {
                ...
                E("Label.Mode",                "モード"),
                E("Label.MaterialList",        "マテリアル一覧"),
                E("Label.DestinationPreset",   "アバタープリセット（コピー先）"),
                E("Label.SourceAvatar",        "コピー元のアバター"),
                E("Label.SourcePreset",        "コピー元のアバタープリセット"),
                E("Label.ExtractResolution",   "抽出解像度"),
                E("ManacoMode.EyeMaterialAssignment", "マテリアル割り当て"),
                E("ManacoMode.CopyEyeFromAvatar",     "別アバターの目をコピー"),
                E("Section.CopyDestination",   "▼ コピー先（自分のアバター）"),
                E("Section.CopySource",        "▼ コピー元（コピーするアバター）"),
                E("Button.OpenUVEditorSource", "UV エディタを開く（コピー元）"),
                E("Message.SourceUVIslandCount", "UV Island 数: {0}"),
                ...
                E("EyeType.Left",              "左目"),
                E("EyeType.Right",             "右目"),
                E("EyeType.BothPupil",         "両目瞳孔"),
                E("EyeType.LeftPupil",         "左目瞳孔"),
                E("EyeType.RightPupil",        "右目瞳孔"),
                E("Tutorial.SelectEyeType",       "{0}を選んでください"),
                E("Tutorial.SelectSourceEyeType", "コピー元の{0}を選んでください"),
                E("Message.MaterialNotSet",    "カスタムマテリアルが未設定です。"),
                E("Message.MatSlotHint",       "メッシュが表示されない場合は ◀ ▶ でマテリアルスロットを切り替えてみてください"),
        ...
        private static void BuildEnLocale(ManacoLocaleData d)
        {
            ...
            d.entries = new List<ManacoLocaleData.LocaleEntry>
            {
                ...
                E("Label.Mode",                "Mode"),
                E("Label.MaterialList",        "Material List"),
                E("Label.DestinationPreset",   "Avatar Preset (Destination)"),
                E("Label.SourceAvatar",        "Source Avatar"),
                E("Label.SourcePreset",        "Source Avatar Preset"),
                E("Label.ExtractResolution",   "Extract Resolution"),
                E("ManacoMode.EyeMaterialAssignment", "Eye Material Assignment"),
                E("ManacoMode.CopyEyeFromAvatar",     "Copy Eye from Avatar"),
                E("Section.CopyDestination",   "▼ Destination (Your Avatar)"),
                E("Section.CopySource",        "▼ Source (Avatar to Copy)"),
                E("Button.OpenUVEditorSource", "Open UV Editor (Source)"),
                E("Message.SourceUVIslandCount", "UV Islands: {0}"),
                ...
                E("EyeType.BothPupil",         "Both Pupil"),
                E("EyeType.LeftPupil",         "Left Pupil"),
                E("EyeType.RightPupil",        "Right Pupil"),
                E("Tutorial.SelectEyeType",       "Please select: {0}"),
                E("Tutorial.SelectSourceEyeType", "Please select source: {0}"),
                E("Message.MaterialNotSet",    "Custom material is not set."),
                E("Message.MatSlotHint",       "If the mesh is not shown, try switching the material slot with ◀ ▶"),
