...
namespace com.kakunvr.manaco.Editor
{
    ...
    public static class ManacoLocale
    {
        ...
        private static readonly Dictionary<string, string> _jaSupplemental = new Dictionary<string, string>
        {
            ...
            ["Tooltip.LightweightMode"] = "Face テクスチャに目の見た目を書き込み、追加マテリアルなしで反映します。",
            ["Message.LightweightModeWarning"] = "最軽量化モードでは Face テクスチャへ焼き込んで反映します。追加のマテリアルスロットは作りませんが、カスタムシェーダーの挙動は再現されません。",
            ["EyeType.LeftPupil"] = "左目瞳孔",
            ["EyeType.RightPupil"] = "右目瞳孔",
        ...
        private static readonly Dictionary<string, string> _enSupplemental = new Dictionary<string, string>
        {
            ...
            ["Tooltip.LightweightMode"] = "Bake the eye appearance into the face texture without adding a new material slot.",
            ["Message.LightweightModeWarning"] = "Lightweight Mode bakes the eye appearance into the face texture. It avoids extra material slots, but custom shader behavior is not preserved.",
