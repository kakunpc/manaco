...
namespace com.kakunvr.manaco.Editor
{
    ...
    public static class ManacoLocale
    {
        ...
        private static readonly Dictionary<string, string> _jaSupplemental = new Dictionary<string, string>
        {
            ...
            ["Label.Mode"] = "モード",
            ["Label.MaterialList"] = "マテリアル一覧",
            ["Label.LightweightResolution"] = "最軽量化解像度",
            ["Toggle.LightweightMode"] = "最軽量化モード",
            ["Tooltip.LightweightMode"] = "目の見た目を Face テクスチャに直接書き込んで反映します。",
            ["Message.LightweightModeWarning"] = "目の見た目を Face テクスチャへ直接書き込むモードです。マテリアルスロットは増えませんが、カスタムシェーダーの表現は使えません。",
            ["Toggle.Legacy01UvRemap"] = "旧 0-1 UV変換を使う",
            ["Tooltip.Legacy01UvRemap"] = "以前の外接矩形を0-1へ正規化する方式で目のUVを変換します。OFFの場合は円形テクスチャ向けの変換を使います。",
            ["Message.CopyModeCircularUvOnly"] = "別アバターの目コピーでは、円形テクスチャ向けのUV変換のみを使用します。",
            ["EyeType.LeftPupil"] = "左目瞳孔",
            ["EyeType.RightPupil"] = "右目瞳孔",
        ...
        private static readonly Dictionary<string, string> _enSupplemental = new Dictionary<string, string>
        {
            ...
            ["Label.LightweightResolution"] = "Lightweight Resolution",
            ["Toggle.LightweightMode"] = "Lightweight Mode",
            ["Tooltip.LightweightMode"] = "Write the eye appearance directly into the face texture.",
            ["Message.LightweightModeWarning"] = "This mode writes the eye appearance directly into the face texture. It does not add material slots, but custom shader effects are not preserved.",
            ["Toggle.Legacy01UvRemap"] = "Use legacy 0-1 UV remap",
            ["Tooltip.Legacy01UvRemap"] = "Use the previous mode that normalizes the selected eye UV bounds to 0-1. When off, circular texture remapping is used.",
            ["Message.CopyModeCircularUvOnly"] = "Copy Eyes From Another Avatar always uses circular texture UV remapping.",
